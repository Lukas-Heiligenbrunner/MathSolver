...
class TestTeacher {
    ...
    @Test
    fun test() {
        val e: Expression = Addition(Var("x"), Var("x"))
...
//        System.out.println(e.simplify().toInfixString()) // Ausgabe: (2.0 * x)
    ...
    fun test2() {
        ...
        val e: Expression = Addition(Var("x"), Val(0.0))
...
//        System.out.println(e.simplify().toInfixString()) // Ausgabe: x
    ...
    @Test
    fun test3() {
        val e: Expression = Addition(Val(0.0), Var("x"))
    ...
    fun test4() {
        ...
        val e: Expression = Addition(Addition(Var("x"), Val(2.0)), Addition(Val(2.0), Var("x")))
